...
public class JDBCPreparedStatementDemo extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
			...
			try {
					...
					PreparedStatement pStmt = connection1.prepareStatement("SELECT * FROM eproduct where price>?");
				...
				try {
					...
					PreparedStatement pStmt2 = 
							...
							connection1.prepareStatement("INSERT INTO eproduct(name,price) values(?, ?)");
